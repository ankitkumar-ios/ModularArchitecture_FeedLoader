...
class RemoteFeedLoaderTest: XCTestCase {
	...
	func test_load_deliveryItemsOn200HTTPResponseWithJSONItem(){
		let (sut, client) = makeSUT()
		let item1 = FeedItem(id: UUID(), description: nil, location: nil, imageURL: URL.init(string: "https://a-url.com")!)
		let item1JSON = [
			"id": item1.id.uuidString,
			"image": item1.imageURL.absoluteString,
		]

		let item2 = FeedItem(id: UUID(), description: "a description", location: "a location", imageURL: URL.init(string: "https://another-url.com")!)
